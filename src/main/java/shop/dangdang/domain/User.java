...
public class User {
    ...
    @JsonBackReference
    private final List<com.sparta.dangdang.domain.Feed> writtenFeeds = new ArrayList<>();          // 내가 작성한 포스트

    @OneToMany(mappedBy = "user")
    private final List<com.sparta.dangdang.domain.FeedLikeUser> likeFeeds = new ArrayList<>();     // 내가 좋아요를 누른 포스트
